  ...
  <div class="row">
  	<div class="col-md-8">
        ...
        <div class="box-header">
          <a href="clientes/0" class="btn btn-success">Novo Cliente</a>
        </div>
        <!-- form start -->
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="clientes/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                    <a href="clientes/<?php echo htmlspecialchars( $value1["id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
