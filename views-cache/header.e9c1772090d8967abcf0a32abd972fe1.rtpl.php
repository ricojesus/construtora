...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-mini"><b>S</b>NT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Sis</b>Notas</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="/fornecedores"><i class="fa fa-users"></i> <span>Fornecedores</span></a></li>
        <li class="active"><a href="/notas"><i class="fa fa-file-text-o"></i> <span>Notas Fiscais</span></a></li>
        <li class="treeview">
